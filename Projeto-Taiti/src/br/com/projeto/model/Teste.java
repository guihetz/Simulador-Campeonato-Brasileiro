...
public class Teste {
    public static void main(String[] args) {
         ...
         Time t1 = new Time("Palmeiras", new ImageIcon("src/br/com/projeto/image/palmeiras_60x60.png"),120,120,125);
         Time t2 = new Time("Chapecoense", new ImageIcon("src/br/com/projeto/image/chapecoense_60x60.png"),120,120,125);
